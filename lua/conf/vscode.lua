...
-- tab related keymaps
keymap('n', '<Space>o', [[:Tabonly<cr>]], opts_desc 'tab: delete other tabs')
keymap('n', '<Space>n', [[:Tabnew<cr>]], opts_desc 'tab: new tab')
keymap('n', '<Space>c', [[:Tabclose<cr>]], opts_desc 'tab: close this tab')
keymap('n', '<Space>f', [[:Tabfirst<cr>]], opts_desc 'tab: first tab')
keymap('n', '<Space>l', [[:Tablast<cr>]], opts_desc 'tab: last tab')
keymap('n', '<Space>[', [[gT]], opts_desc 'tab: previous tab')
keymap('n', '<Space>]', [[gt]], opts_desc 'tab: next tab')
keymap('n', '<Space>1', notify 'workbench.action.openEditorAtIndex1', opts_desc 'tab: 1st tab')
keymap('n', '<Space>2', notify 'workbench.action.openEditorAtIndex2', opts_desc 'tab: 2nd tab')
keymap('n', '<Space>3', notify 'workbench.action.openEditorAtIndex3', opts_desc 'tab: 3rd tab')
keymap('n', '<Space>4', notify 'workbench.action.openEditorAtIndex4', opts_desc 'tab: 4st tab')
keymap('n', '<Space>5', notify 'workbench.action.openEditorAtIndex5', opts_desc 'tab: 5st tab')
keymap('n', '<Space>6', notify 'workbench.action.openEditorAtIndex6', opts_desc 'tab: 6st tab')
keymap('n', '<Space>7', notify 'workbench.action.openEditorAtIndex7', opts_desc 'tab: 7st tab')
keymap('n', '<Space>8', notify 'workbench.action.openEditorAtIndex8', opts_desc 'tab: 8st tab')
keymap('n', '<Space>9', notify 'workbench.action.openEditorAtIndex9', opts_desc 'tab: 9st tab')
